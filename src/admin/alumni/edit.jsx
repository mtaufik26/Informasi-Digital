...
export default function EditAlumniPage() {
  ...
  useEffect(() => {
    // Fetch alumni data based on ID
    // Example:
    // fetchAlumniById(id).then(data => {
    //   setFormData(data);
      ...
      <div className="p-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-semibold">Edit Alumni</h1>
          </div>
                    ...
                    <div className="relative">
                      ...
                      {isOpenJurusan && (
                        <div className="absolute left-0 right-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 z-10 p-4">
                          <p className="text-sm font-medium text-gray-900 mb-3">Select Jurusan</p>
